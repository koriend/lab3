...
public class Shorty extends StoryTelling {
    ...
    public void watchStars(Shorty temp1) {
        ...
        System.out.println(temp1.watch(temp1.getName()) + " " + stars.getReallyCount() + stars.getProperty() + " " + stars.getName());
    ...
    public void watchEarth(Shorty temp1, Planet temp2) {
        ...
        System.out.println("\n");
        System.out.println(temp2.getName() + " имеет форму не" + Planet.Shape.SICKLE.getShape() + " или " + Planet.Shape.CRESCENT.getShape() + ", а" + Planet.Shape.DISK.getShape() + "а");
    ...
    public void watchRocket(Shorty temp1, Machine temp2){
        System.out.println(temp1.watch(temp1.getName()) + temp2.getDist() + temp2.getName());
        temp2.setName("Ракета");
